    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <a class="btn btn-sm btn-primary mb-3" href="{{ route('admindesa_laporan.tambahpengajuan') }}">Buat
                        Laporan</a>
                    <table id='table' class="table table-bordered table-hover dataTable dtr-inline">
                        ...
                        <tbody>
                            @foreach ($daftar_laporan->where('tipe', 'proposal')->all() as $laporan)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-warning"
                                        href="{{ route('admindesa_laporan.ubahpengajuan', $laporan->id_laporan) }}">Ubah</a>
                                    <a class="btn btn-danger"
                                        href="{{ route('admindesa_laporan.hapuspengajuan', $laporan->id_laporan) }}">Hapus</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
