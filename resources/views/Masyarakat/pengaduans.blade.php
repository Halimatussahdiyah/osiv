...
<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="/masyarakat/pengaduan_tambah" type="button" class="btn btn-info mt-0 mb-3 p-2"><b> <i
            ...
            <table id="table" class="table table-bordered table-hover dataTable dtr-inline">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="/masyarakat/pengaduan_hapus" method="POST" class="d-flex gap-1">
                                {{-- <a href="/masyarakat/pengaduan_edit/{{ $pengaduan->id }}"
                                    class="btn btn-warning mr-2" style="text-decoration: none">Edit</a> --}}
                                <a href="/masyarakat/pengaduan_detail/{{ $pengaduan->id }}" class="btn btn-info mr-2"
