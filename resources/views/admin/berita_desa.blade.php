...
<div class="card">
    ...
    @endif
    <div class="card-body">
        <a href="/admin/tambah_berita" type="button" class="btn btn-info mt-0 mb-3 p-2"><b> <i
                    class="bi bi-plus-square"></i> </b>&nbsp; Tambah Data Berita</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <img width="100px" class="img-responsive avatar-view"
                            src="{{URL::to('/')}}/foto_kegiatan/{{$berita->foto_kegiatan}}" alt="Avatar"
                            title="Change the avatar"></td>
                    <td>{{ $berita->tanggal }}</td>
                    <td>{{ $berita->penulis }}</td>
                    <td>

                        <form action="/admin/hapus_berita" method="POST" class="d-flex gap-1">
                            @csrf
                            <a href="/admin/edit_berita/{{$berita->id}}" class="btn btn-warning"
                                style="text-decoration: none">Edit</a>
                            <input type="hidden" name="id" id="id" value="{{ $berita->id }}">
                            <button type="submit" class="btn btn-danger ml-1">Hapus</button>
                            <a href="/admin/detail_berita/{{$berita->id}}" class="btn btn-info ml-1"
