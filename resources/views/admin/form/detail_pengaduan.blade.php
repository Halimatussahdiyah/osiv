...
<div class="form-group">
  ...
  <textarea type="text" name="nama_pelapor" class="form-control" id="nama pelapor" placeholder="nama pelapor" value=""
...
<div class="form-group">
  ...
  <textarea type="text" name="tanggapan" class="form-control" id="tanggapan" placeholder="belum di tanggapi oleh admin"
